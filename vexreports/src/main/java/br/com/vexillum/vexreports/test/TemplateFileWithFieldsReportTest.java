...
public class TemplateFileWithFieldsReportTest extends BaseDjReportTest {
	...
	public DynamicReport buildReport() throws Exception {
		...
		drb.setDetailHeight(15)						//defines the height for each record of the report
...
//		drb.addColumn(columnAmount);
		...
		drb.setTemplateFile(System.getProperty("user.dir")
				+ "/target/reports/fichaindividual.jrxml",false,false,true,false);
...
//		drb.setTemplateFile(System.getProperty("user.dir") + "/target/test-classes/templates/TemplateReportTestPortLandscape.jrxml");
		...
		params.put("fullName", "DynamicJasper is the Best!!!");
		params.put("recordName", "NAO FUNCIONA!");
		params.put("reportTitle", "FERNANDO É GAY");
		params.put("rg", "FERNANDO É GAY");
		params.put("cpf", "FERNANDO É GAY");
